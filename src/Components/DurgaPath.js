  ...
  return (
    <div>
      <div className="relative">
        <img
          src="https://png.pngtree.com/thumb_back/fw800/background/20230711/pngtree-illustration-of-a-3d-rendered-statue-depicting-the-hindu-deity-ganesha-image_3832470.jpg"
          className="w-full h-[500px]"
        />
        <div className="absolute top-36 left-20">
          <h1 className="text-white text-4xl font-semibold pb-4">Our Puja</h1>
          <p className=" text-white text-2xl font-semibold">
            Home <span className="text-red-600 text-2xl"> >> </span> DurgaPath
          </p>
        </div>
      </div>
