    ...
    <div>
      <div>
        <div className="relative">
          <img
            src="https://kalsarpyogdoshpuja.com/img/demos/kaal-sarp-bg.jpg"
            className="w-full h-[500px]"
          />
          <div className="absolute top-36 left-20">
            <h1 className="text-white text-4xl font-semibold pb-4">Our Puja</h1>
            <p className=" text-white text-2xl font-semibold">
              Home <span className="text-red-600 text-2xl"> >> </span> Kalsarp
              Puja
            </p>
          </div>
        </div>
        ...
        <div className="py-14 w-8/12 mx-auto lg:flex gap-6">
          <div className="lg:w-[60%]">
            ...
            <h1 className="text-2xl font-semibold text-justify">
              Then God will be pleased with us and shower His abundant grace
              upon us.
            </h1>
