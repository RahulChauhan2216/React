  ...
  return (
    <div>
      <div className="relative">
        <img
          src="https://i.ebayimg.com/images/g/HdIAAOSwjsVjKsEp/s-l1200.webp"
          className="w-full h-[500px]"
        />
        <div className="absolute top-36 left-20">
          <h1 className="text-white text-4xl font-semibold pb-4">Services</h1>
          <p className=" text-white text-2xl font-semibold">
            Home <span className="text-red-600 text-2xl"> >> </span> Prayers
          </p>
        </div>
      </div>
      ...
      <div className="py-14 w-8/12 mx-auto lg:flex gap-6">
        <div className="lg:w-[60%]">
          ...
          <img src="https://andthemedia.com/daksh-wordpress/wp-content/uploads/2023/03/ser-d-2.png" />
          ...
          <div className="flex gap-4 overflow-hidden">
            <img
              src="https://andthemedia.com/daksh-wordpress/wp-content/uploads/2023/03/ser-d-3.png"
              className="w-6/12"
            />
            <img
              src="https://andthemedia.com/daksh-wordpress/wp-content/uploads/2023/03/ser-d-4.png"
              className="w-6/12"
            />
          </div>
